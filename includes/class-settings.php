...
class SecuritySettings {
    ...
    public function register_settings() {
        $settings = array(
            ...
            // Bot blocking settings
            'security_enable_bot_blocking', 'security_bot_skip_logged_users',
            'security_bot_max_requests_per_minute', 'security_bot_block_threshold',
            'security_bot_block_message', 'security_bot_log_retention_days'
        );
